...
{ 
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		try
		{
			...
			document.getElementById("pdf_totalcount").innerHTML = (523).toString();
			document.getElementById("pdf_dealedcount").innerHTML = (278).toString();
			document.getElementById("pdf_pro").style.width = divide((278).toString(),(523).toString());
			
			document.getElementById("doc_totalcount").innerHTML = (329).toString();
			document.getElementById("doc_dealedcount").innerHTML = (299).toString();
			document.getElementById("doc_pro").style.width = divide((299).toString(),(329).toString());
			
			document.getElementById("picture_totalcount").innerHTML = (1809).toString();
			document.getElementById("picture_dealedcount").innerHTML = (12).toString();
			document.getElementById("picture_pro").style.width = divide((12).toString(),(1809).toString());
		}
		catch(Exception){}
	} 
}
